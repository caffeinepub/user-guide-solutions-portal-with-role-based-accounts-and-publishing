...
export class Backend implements backendInterface {
    ...
    async getBlogs(): Promise<Array<Post>> {
        if (this.processError) {
            try {
    ...
    async getBlogsByMe(): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBlogsByMe();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerDrafts(): Promise<Array<Draft>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerDrafts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPostsByMe(): Promise<Array<Post>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPostsByMe();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTaggedPostIds(arg0: string): Promise<Array<PostId> | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTaggedPostIds(arg0);
    ...
    async getUntaggedPosts(): Promise<Array<PostId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUntaggedPosts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async publish(arg0: PostId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async removeDraft(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeDraft(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDraft(arg0: string, arg1: string, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDraft(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitBlog(arg0: string, arg1: string, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBlog(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPost(arg0: string, arg1: string, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPost(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unpublish(arg0: PostId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unpublish(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePost(arg0: PostId, arg1: string, arg2: string, arg3: Array<string>): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_Post>]): Array<Post> | null {
...
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_PostId>]): Array<PostId> | null {
    return value.length === 0 ? null : value[0];
}
